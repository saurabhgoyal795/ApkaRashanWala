...
public class IndividualProperty extends AppCompatActivity {
    ...
    private SliderLayout sliderShow2;
    ...
    private void initialize() {
        ...
        sliderShow2 = findViewById(R.id.slider2);

        //populating Image slider
        ArrayList<String> sliderImages= new ArrayList<>();
        ArrayList<String> sliderImages2= new ArrayList<>();
            ...
            try {
                ...
                for(int k = 0; k< morePhotosJson.length(); k++){
                    if(morePhotosJson.getString(k).contains("http")){
                        sliderImages2.add(morePhotosJson.getString(k));
                    } else {
                        sliderImages2.add(CustomApplication.imagePath +morePhotosJson.getString(k));
                    }
                }
        ...
        for (String s:sliderImages2){
            DefaultSliderView sliderView=new DefaultSliderView(this);
            sliderView.image(s);
            sliderShow2.addSlider(sliderView);
        }

        sliderShow.setPresetIndicator(SliderLayout.PresetIndicators.Right_Bottom);
        sliderShow2.setPresetIndicator(SliderLayout.PresetIndicators.Right_Bottom);
    ...
    public void Notifications(View view) {
        startActivity(new Intent(IndividualProperty.this, NotificationActivity.class));
        finish();
    }
...
//    }
    ...
    public void increment(View view) {
        if (quantity < 500) {
            ...
            Toast.makeText(IndividualProperty.this, "Product Count Must be less than 500", Toast.LENGTH_LONG).show();
        }
    }
    ...
    TextWatcher productcount = new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (Integer.parseInt(quantityProductPage.getText().toString()) >= 20) {
                Toast.makeText(IndividualProperty.this, "Product Count Must be less than 20", Toast.LENGTH_LONG).show();
            }
        }
...
// Here, thisActivity is the current activity
        if (ContextCompat.checkSelfPermission(getApplicationContext(),
            ...
            ActivityCompat.requestPermissions(IndividualProperty.this,
    ...
    class AddToCartTask extends AsyncTask<Boolean, Void , Boolean> {
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            Toast.makeText(IndividualProperty.this, "Added to Cart", Toast.LENGTH_SHORT).show();
            if (aBoolean){
                startActivity(new Intent(IndividualProperty.this,Cart.class));
                finish();
            }
